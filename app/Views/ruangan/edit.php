    ...
    <form action="<?= base_url('ruangan/update/' . $ruangan['id']) ?>" method="POST">
        ...
        <div class="space-y-4">
            ...
            <div class="flex items-center">
                <input id="is_active" name="is_active" type="checkbox" value="1" <?= old('is_active', $ruangan['is_active']) ? 'checked' : '' ?> class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
